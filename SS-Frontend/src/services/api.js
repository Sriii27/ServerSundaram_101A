...
// Use VITE_ prefix for Vite environment variables, with fallback to localhost
const BASE_URL = import.meta.env.VITE_API_URL || import.meta.env.API_URL || 'http://127.0.0.1:8000'
